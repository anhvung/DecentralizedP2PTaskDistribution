...
to setup-probabilistic
  ...
  ifelse leader-designation[ ;;si le leader-designation est sur off alors on innitialise le point d'entrée à l'aide de la fonction elect-root
    let k elect-root
    ask brain k[
      let i 0
...
to setup-gossip
  ...
  [
    ifelse leader-designation[ ;; Si initialize-gossip OFF ET si le leader-designation est sur on  alors on innitialise le point d'entrée à l'aide de la fonction elect-root
      let q elect-root
      ask brain q[
        let k 0
